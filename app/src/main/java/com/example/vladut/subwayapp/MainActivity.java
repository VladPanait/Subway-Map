...
//        myDB.insertStation(new SubwayStation("Preciziei", new PointF(100, 800)));
//        Log.d(TAG,"first insert");
//
//        myDB.insertStation(new SubwayStation("Pacii", new PointF(150, 750)));
//        Log.d(TAG,"second insert");
//        myDB.insertStation(new SubwayStation("Gorjului", new PointF(200, 750)));
//        myDB.insertStation(new SubwayStation("Lujerului", new PointF(250, 750)));
//        myDB.insertStation(new SubwayStation("Politehnica", new PointF(300, 750)));
...
//        myDB.insertStation(new SubwayStation("1 decembrie", new PointF(750, 950)));
//        myDB.insertStation(new SubwayStation("Nicolae Teclu", new PointF(800, 950)));
//        myDB.insertStation(new SubwayStation("Anghel Saligny", new PointF(850, 950)));
//
//
